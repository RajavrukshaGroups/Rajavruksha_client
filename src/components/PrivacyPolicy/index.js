  ...
  return (
    <div>
      ...
      <div className="introduction">
        ...
        <p className="para-text">
          We at Rajavruksha Realtors Pvt. Ltd. are committed to protecting your
          privacy. This Privacy Policy explains how we collect, use, disclose,
          and safeguard your information when you visit our website. Please read
          this policy carefully. If you disagree with the terms of this privacy
      ...
      <div className="introduction">
        ...
        <ul className="list-methods">
          <p className="para-text">
            We Collect Personal Data We may collect personally identifiable
            information "Personal Data" about you when you voluntarily provide
            this information to us. This may include: - Name - Email address -
            Telephone number - Mailing address - Location - Any other
      ...
      <div className="introduction">
        ...
        <p className="para-text">
          ...
          acceptance of this policy. If you do not agree to our above policies
          you could restrain from the use of our website. Your continued use of
