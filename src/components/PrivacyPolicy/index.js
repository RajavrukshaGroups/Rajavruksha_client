    ...
    <div>
      ...
      <div className="introduction">
        ...
        {/* <p className="para-text">
          We At Rajavruksha Realtors Pvt. Ltd. we value your privacy and are
      ...
      <div className="introduction">
        ...
        <p className="para-text">
        We at Rajavruksha Realtors Pvt. Ltd. are committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website. Please read this policy carefully. If you disagree with the terms of this privacy policy, please do not access the site.
        </p>
        {/* <p className="para-text">
      ...
      <div className="introduction">
        <p className="para-heading">2.  Information</p>
        <ul className="list-methods">
          <p className="para-text">
          We Collect Personal Data We may collect personally identifiable information "Personal Data" about you when you voluntarily provide this information to us. This may include: - Name - Email address - Telephone number - Mailing address - Location - Any other information you provide to us directly
          </p>
          
        </ul>
      </div>
      <div className="introduction">
        <p className="para-heading">3. How We Use Your Information</p>
        <p className="para-text">
      ...
      <div className="introduction">
        <p className="para-heading">4. Sharing Your Information</p>
        <p className="para-text">
        We do not sell, trade, or rent your personal identification information to others. We may share generic aggregated demographic information not linked to any personal identification information regarding visitors and users with our business partners, trusted affiliates, and advertisers.
        </p>
      </div>
      <div className="introduction">
        <p className="para-heading"> 5. Protecting Your Information </p>
        <p className="para-text">
        We adopt appropriate data collection, storage, and processing practices and security measures to protect against unauthorized access, alteration, disclosure, or destruction of your personal information, username, password, transaction information, and data stored on our Site
        </p>
      </div>
      <div className="introduction">
        <p className="para-heading"> 6. Changes to This Privacy Policy </p>
        <p className="para-text">Rajavruksha Realtors Pvt. Ltd. can update this privacy policy at any time. We encourage users to frequently check this page for any changes to stay informed about how we are helping to protect the personal information we collect. By using this Site, you signify your acceptance of this policy. If you do not agree to our above policies you could restrain from the use of our website. Your continued use of the Site following the posting of changes to this policy will be deemed your acceptance of those changes. With the terms of this privacy policy, please do not access the site.</p>
